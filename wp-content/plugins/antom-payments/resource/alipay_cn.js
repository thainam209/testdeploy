...
const settings = getSetting('antom_alipay_cn_data', {});
 ...
 */
const antom_alipay_cn = {
	name: "antom_alipay_cn",
	...
	paymentMethodId: 'antom_alipay_cn',
	supports: {
		features: settings.supports,
	},
};

registerPaymentMethod(antom_alipay_cn);
