...
<div class="wp-block-group">
    ...
    <!-- wp:group {"style":{"typography":{"textTransform":"lowercase"},"spacing":{"padding":{"top":"28px","right":"28px","bottom":"28px","left":"28px"}}},"backgroundColor":"secondary-alt","className":"wp-block-widget"} -->
    <div class="wp-block-group wp-block-widget has-secondary-alt-background-color has-background" style="padding-top:28px;padding-right:28px;padding-bottom:28px;padding-left:28px;text-transform:lowercase"><!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}},"fontSize":"medium"} -->
        <h2 class="has-medium-font-size" id="categories" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_attr_e('Categories', 'infinix'); ?></h2>
        <!-- /wp:heading -->
    ...
    <div class="wp-block-group wp-block-widget has-secondary-alt-background-color has-background" style="padding-top:28px;padding-right:28px;padding-bottom:28px;padding-left:28px"><!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}},"fontSize":"medium"} -->
        <h2 class="has-medium-font-size" id="categories" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_attr_e('filter by price', 'infinix'); ?></h2>
        <!-- /wp:heading -->
    ...
    <!-- wp:group {"style":{"typography":{"textTransform":"lowercase"},"spacing":{"padding":{"top":"28px","right":"28px","bottom":"28px","left":"28px"}}},"backgroundColor":"secondary-alt","className":"wp-block-widget  wp-filter-by-size","fontSize":"small"} -->
    <div class="wp-block-group wp-block-widget wp-filter-by-size has-secondary-alt-background-color has-background has-small-font-size" style="padding-top:28px;padding-right:28px;padding-bottom:28px;padding-left:28px;text-transform:lowercase"><!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}},"fontSize":"medium"} -->
        <h2 class="has-medium-font-size" id="categories" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_attr_e('filter by size', 'infinix'); ?></h2>
        <!-- /wp:heading -->
    ...
    <!-- wp:group {"style":{"typography":{"textTransform":"lowercase"},"spacing":{"padding":{"top":"28px","right":"28px","bottom":"28px","left":"28px"}}},"backgroundColor":"secondary-alt","className":"wp-block-widget wp-filter-by-color","fontSize":"small"} -->
    <div class="wp-block-group wp-block-widget wp-filter-by-color has-secondary-alt-background-color has-background has-small-font-size" style="padding-top:28px;padding-right:28px;padding-bottom:28px;padding-left:28px;text-transform:lowercase"><!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}},"fontSize":"medium"} -->
        <h2 class="has-medium-font-size" id="categories" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_attr_e('filter by color', 'infinix'); ?></h2>
        <!-- /wp:heading -->
