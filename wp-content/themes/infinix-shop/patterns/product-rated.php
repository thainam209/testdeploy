...
/**
 * Title: Product Rated
 * Slug: infinix-shop/product-rated
 * Categories: infinix-shop
 */
?>

<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"bottom":"var:preset|spacing|80","right":"var:preset|spacing|50","left":"var:preset|spacing|50"}}},"className":"has-global-padding wp-section-block wp-section-product wp-rated-product","layout":{"type":"constrained"}} -->
<div class="has-global-padding wp-block-group alignfull wp-section-block wp-section-product wp-rated-product" style="padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50)"><!-- wp:group {"align":"wide","className":"wp-section-container-block","layout":{"type":"default"}} -->
	<div class="wp-block-group alignwide wp-section-container-block"><!-- wp:group {"style":{"spacing":{"blockGap":"14px","margin":{"bottom":"var:preset|spacing|40"}}},"className":"wp-section-header-block","layout":{"type":"constrained"}} -->
		<div class="wp-block-group wp-section-header-block" style="margin-bottom:var(--wp--preset--spacing--40)"><!-- wp:heading {"textAlign":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"className":"animate-block"} -->
			<h2 class="has-text-align-center animate-block" style="font-style:normal;font-weight:400"><?php esc_html_e('Top Rated Products.', 'infinix-shop'); ?></h2>
			<!-- /wp:heading -->
		...
		<div class="wp-block-group alignwide wp-section-content-block has-small-font-size"><!-- wp:woocommerce/product-top-rated {"columns":5,"rows":2,"stockStatus":["","instock","outofstock","onbackorder"],"align":"wide"} /--></div>
		<!-- /wp:group -->
	</div>
	<!-- /wp:group -->
</div>
